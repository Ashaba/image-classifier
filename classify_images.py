...
def classify_images(images_dir, results_dic, model):
    ...
    """
    filenames = [file_name for file_name, label in results_dic.items()]
    pet_labels = [label[0] for file_name, label in results_dic.items()]
    classifier_labels = [classifier(images_dir + file_name, model).lower().strip() for file_name in filenames]
