...
#                                                                             
# PROGRAMMER: John Ashabahebwa
# DATE CREATED: 28/01/2020                             
# REVISED DATE: 28/01/2020
...
def calculates_results_stats(results_dic):
    ...
    n_dogs_img, n_notdogs_img, n_correct_dogs, n_label_matches = 0, 0, 0, 0
    n_correct_notdogs, n_correct_breed = 0, 0
    ...
    pct_label_matches = round((n_label_matches/n_images) * 100, 1)
    ...
    results_stats_dic['n_label_matches'] = n_correct_breed
